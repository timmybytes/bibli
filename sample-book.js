...
const book = {
  'ISBN:9780980200447': {
    ...
    title: 'Slow reading',
    authors: [
      { url: 'https://openlibrary.org/authors/OL6548935A/John_Miedema', name: 'John Miedema' },
    ],
    number_of_pages: 92,
    pagination: '80p.',
    weight: '1 grams',
    ...
    classifications: { lc_classifications: ['Z1003 .M58 2009'], dewey_decimal_class: ['028/.9'] },
    publishers: [{ name: 'Litwin Books' }],
    publish_places: [{ name: 'Duluth, Minn' }],
    publish_date: 'March 2009',
    subjects: [
      { name: 'Books and reading', url: 'https://openlibrary.org/subjects/books_and_reading' },
    ...
    table_of_contents: [
      ...
      { level: 0, label: '', title: 'The slow movement and slow reading', pagenum: '' },
      { level: 0, label: '', title: 'The psychology of slow reading', pagenum: '' },
      { level: 0, label: '', title: 'The practice of slow reading.', pagenum: '' },
    ],
    links: [
      { title: "Author's Website", url: 'http://johnmiedema.ca' },
      { title: 'Chapter 2', url: 'http://litwinbooks.com/slowreading-ch2.php' },
      { title: 'Get the e-book', url: 'http://www.powells.com/biblio/91-9781936117369-0' },
    ],
    ebooks: [
      {
